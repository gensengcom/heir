...
impl HeirBinarySessionFile {
    ...
    fn read_from_file<R: Read>(reader: &mut R) -> std::io::Result<Self> {
...
mod tests {
    ...
    fn test_heir_bin_file() {
        // create sample file
        let file = HeirBinarySessionFile {
            session_id: 1,
            tables: vec![Table {
                id: 1,
        ...
        let read_file = HeirBinarySessionFile::read_from_file(&mut reader).unwrap();
